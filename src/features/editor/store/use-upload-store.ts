...
// persist middleware removed - blob URLs don't survive page refresh
...
const useUploadStore = create<IUploadStore>()(
  ...
  // NOTE: Removed persist middleware because blob URLs don't survive page refresh
  // Users need to re-upload videos after refresh
);
